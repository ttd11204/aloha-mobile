...
export default function PrivacyPolicy() {
  ...
  return (
    <SafeAreaView
      className='flex-1 bg-[#f5f7fb] pt-10 pb-5'
        ...
        <View className='p-5 pb-10'>
          ...
          <View className='bg-white rounded-2xl p-5 mb-6 flex-row items-center shadow'>
            ...
            <Text className="flex-1 font-['Poppins-Medium'] text-base text-[#333] leading-6">
              ...
              your data during treasure hunts.
            </Text>
          </View>
          ...
          <View className='mb-6'>
            <View className='flex-row items-center mb-4'>
              ...
              <Text className="font-['Poppins-SemiBold'] text-xl text-[#333]">
                Information We Collect
              </Text>
            </View>
            <View className='bg-white rounded-2xl p-5 ml-[18px] border-l-2 border-l-[#187af2] shadow'>
              <Text className="font-['Poppins-Regular'] text-base text-[#333] mb-3 leading-6">
                We collect minimal information to provide our treasure hunt
                services:
              </Text>
              ...
              <View className='mb-4'>
                <View className='flex-row items-start mb-3'>
                  ...
                  <Text className="font-['Poppins-Regular'] text-base text-[#333] ml-3 flex-1 leading-[22px]">
                    Temporary location data during active treasure hunts (with
                    your permission)
                  </Text>
                </View>
                <View className='flex-row items-start mb-3'>
                  ...
                  <Text className="font-['Poppins-Regular'] text-base text-[#333] ml-3 flex-1 leading-[22px]">
                    Basic game progress for active hunts
                  </Text>
                </View>
              </View>
              ...
              <View className='bg-[#f0f4ff] rounded-xl p-4 flex-row items-center'>
                ...
                <Text className="font-['Poppins-Medium'] text-sm text-[#187af2] ml-3 flex-1">
                  All hunt data is temporary and is not stored after the hunt
                  ends.
                </Text>
              </View>
            </View>
          ...
          <View className='mb-6'>
            ...
            <View className='bg-white rounded-2xl p-5 ml-[18px] border-l-2 border-l-[#187af2] shadow'>
              <Text className="font-['Poppins-Regular'] text-base text-[#333] mb-3 leading-6">
                We use this temporary information only to:
              </Text>
              ...
              <View className='mb-4'>
                <View className='flex-row items-start mb-3'>
                  ...
                  <Text className="font-['Poppins-Regular'] text-base text-[#333] ml-3 flex-1 leading-[22px]">
                    Operate the current treasure hunt experience
                  </Text>
                </View>
                <View className='flex-row items-start mb-3'>
                ...
                <View className='flex-row items-start mb-3'>
                  ...
                  <Text className="font-['Poppins-Regular'] text-base text-[#333] ml-3 flex-1 leading-[22px]">
                    Ensure fair play during active hunts
                  </Text>
                </View>
              </View>
            </View>
            ...
            <View className='bg-white rounded-2xl p-5 ml-[18px] border-l-2 border-l-[#187af2] shadow'>
              <View className='bg-[#f0f4ff] rounded-xl p-5 flex-row items-center'>
                ...
                <Text className="font-['Poppins-Medium'] text-base text-[#333] ml-4 flex-1 leading-6">
                  We do not store any personal information. All hunt-related
                  data is automatically deleted when your hunt ends.
                </Text>
              </View>
            </View>
          </View>
          ...
          <View className='mb-6'>
            ...
            <View className='bg-white rounded-2xl p-5 ml-[18px] border-l-2 border-l-[#187af2] shadow'>
              ...
              <TouchableOpacity className='bg-[#187af2] rounded-xl p-4 flex-row items-center justify-center mt-3'>
                ...
                <Text className="font-['Poppins-Medium'] text-base text-white ml-3">
                  alohavietnamretreat@gmail.com
                </Text>
              </TouchableOpacity>
            </View>
          </View>
          ...
          <View className='items-center mt-5'>
            <Text className="font-['Poppins-Regular'] text-sm text-[#999]">
